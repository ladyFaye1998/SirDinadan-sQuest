...
# Sir Dinadan's Quest
**[🎮 Play the game live in your browser!](https://ladyfaye1998.github.io/SirDinadan-sQuest/)**
...
The repository is fully automated using a custom GitHub Actions pipeline. The cloud-native architecture performs headless engine compilation via GameCI, dynamically injects C# Editor scripts to override Unity's default WebGL Brotli compression at runtime, and deploys the compiled HTML5 artifacts directly to GitHub Pages.
